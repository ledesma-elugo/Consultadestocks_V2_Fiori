		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#arledesmafiorimmconsStockv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arledesmafiorimmconsStockv2-display": {
								"semanticObject": "arledesmafiorimmconsStockv2",
								"action": "display",
								"description": "Consulta de Stocks",
								"title": "Consulta de stocks",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ar.ledesma.fiori.mm.consultastock",
									"url": sap.ui.require.toUrl("ar/ledesma/fiori/mm/consultastock")
								}
							}
						}
					}
